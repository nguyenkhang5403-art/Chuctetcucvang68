let datetxt = "Xuân 2026 🎊";
let datatxtletter =
"Chúc Em Một Năm Mới Luôn Bình An và Hạnh Phúc.\n\n" +
"Mong rằng năm mới sẽ mang đến cho em thật nhiều niềm vui, " +
"sức khỏe dồi dào và mọi điều tốt đẹp nhất.\n\n" +
"Luôn mỉm cười, luôn an yên và hạnh phúc em nhé 🌸✨";

// let datatxtletter = "Chúc Em Một Năm Mới Luôn Bình An và Hạnh Phúc.\n\n Mong rằng năm mới sẽ mang đến cho em thật nhiều niềm vui, .";
let titleLetter = "Lời Chúc Năm Mới";
